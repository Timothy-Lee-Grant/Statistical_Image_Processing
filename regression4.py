...
def main():
  ...
  for i in range(1000):
    if i % 100 == 0:
      weightVector, crossEntropyLoss = findGradient(trainData, weightVector, onMatrix, stepSize, 1)
      crossEntropyLossList.append(crossEntropyLoss)
      x_axis.append(i)
      print(crossEntropyLoss)
    else:
      weightVector, crossEntropyLossDummy = findGradient(trainData, weightVector, onMatrix, stepSize, 0)
